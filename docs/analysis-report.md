...
- **Aktuelle Iteration (Fortsetzung):** Kopfbereich bietet jetzt ein State-Digest-Dashboard mit Karten für Module, Plugins, Playlist und Archiv, laienfreundlichen Tipps sowie einem begrenzten Änderungsverlauf; Tests prüfen die Historienbegrenzung.
