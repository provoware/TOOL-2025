...
- `npm test`: Node-gestützte Tests (Playlist-Kurzbefehle, Backup-Schema, Plugin-Registrierung, Self-Repair-Basics, Präventionshinweis-Deduplizierung) inklusive automatischem Lint-Lauf via `pretest`.
