...
- `npm test`: Node-gestützte Tests (Playlist-Kurzbefehle, Backup-Schema, Plugin-Registrierung, Self-Repair-Basics, Präventionshinweis-Deduplizierung, Modul-Duplikatschutz, Fokusfalle im Hilfe-Dialog, Start-Check-Report) inklusive automatischem Lint-Lauf via `pretest`.
